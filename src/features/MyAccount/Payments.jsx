...
export default function Payments() {
    ...
    return (
        <div className="w-full p-6 mx-auto">
            <h1 className="text-2xl font-semibold text-cyan-800 mb-8">Payment Methods</h1>
            ...
            <div className="bg-cyan-800 shadow-lg rounded-lg p-6">
                ...
                <div className="space-y-4">
                    {paymentMethods.map(method => (
                        <div key={method.id} className="flex items-center justify-between bg-cyan-700 p-4 rounded-lg">
